...
get_header(); ?>
  ...
  rgba(181, 122, 85, 0.3)
), url('http://mothers-day-2022.local/wp-content/uploads/2022/04/Mothers-Day-Header-Cropped.jpg') left center; background-repeat: no-repeat; background-size: cover; height: 80vh;">
        <div class="content-middle text-white text-left p-5 xl:w-1/2">
