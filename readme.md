...
Mama Llama is a wordpress theme designed to suit the needs of fcmothersday.com. It makes use of webpack, Babel, Sass, Tailwind, Browsersync, PostCSS, ESLint, Stylelint, Prettier and more. It is meant for that site, but if you can use it by all means go for it.
***
...
$ git clone https://github.com/Myzwer/mothers-day-2022
